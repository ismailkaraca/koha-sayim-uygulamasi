...
export default function App() {
    ...
    const renderPageContent = () => {
        switch (page) {
            case 'permission':
                return <PermissionScreen onDecision={handlePermissionDecision} />;
            case 'start':
            ...
            case 'scan':
                return renderScanScreen(); // Scan is now handled like other pages
            default:
                return null;
        }
    };
